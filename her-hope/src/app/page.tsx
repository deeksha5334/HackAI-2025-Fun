    ...
    <div className="container mx-auto px-4 pb-20">
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="bg-white/80 shadow-md">
          <CardHeader>
            <CardTitle className="text-xl text-pink-500">User Profile</CardTitle>
          </CardHeader>
          <CardContent className="flex flex-col items-center">
            <Avatar className="h-32 w-32 bg-pink-200">
              <AvatarFallback className="text-4xl text-pink-500">UN</AvatarFallback>
            </Avatar>
            <div className="mt-4 rounded-full border border-dashed border-pink-300 px-6 py-2 text-center">UserName</div>
